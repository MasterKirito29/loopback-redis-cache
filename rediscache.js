module.exports = function(Model, options) {
    ...
    Model.beforeRemote('**', function(ctx, res, next) {
        ...
        if((ctx.method.name.indexOf("count") !== -1 || ctx.method.name.indexOf("find") !== -1 || ctx.method.name.indexOf("__get") !== -1) && client.connected){
            if(typeof ctx.req.query.cache != 'undefined'){
                ...
                console.log("JSON.stringify(ctx.req.query) : " + JSON.stringify(ctx.req.query));
